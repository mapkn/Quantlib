...
# Deposit rates
depo_maturities = [ql.Period(1,ql.Days), ql.Period(1, ql.Months), ql.Period(3, ql.Months)]
depo_rates = [0.0117889/100, 0.0123611/100,0.01325/100]
#depo_rates = depo_rates/100

# Futures 

future_prices=[98.675,98.53,98.445,98.37,98.31,98.23,98.185]
futures_IMM=['U7','Z7','H8','M8','U8','Z8','H9']
...
fut_IMM=[ql.IMM.nextDate(imm) for f in future_prices]
...
future_helpers=[]
#future_helpers=[ql.FuturesRateHelper(ql.QuoteHandle(future_prices[d]),
#                      i,
                       
#                      for r,i in zip(futures_prices, futures_IMM))
